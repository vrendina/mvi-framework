...
public class CustomViewDragHelper {
     ...
     */
    public static CustomViewDragHelper create(ViewGroup forParent, Callback cb) {
        return new CustomViewDragHelper(forParent.getContext(), forParent, null, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static CustomViewDragHelper create(ViewGroup forParent, Interpolator interpolator, Callback cb) {
        return new CustomViewDragHelper(forParent.getContext(), forParent, interpolator, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static CustomViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
     ...
     * @return a new ViewDragHelper instance
     */
    public static CustomViewDragHelper create(ViewGroup forParent, float sensitivity, Interpolator interpolator, Callback cb) {
        final CustomViewDragHelper helper = create(forParent, interpolator, cb);
        helper.mTouchSlop = (int) (helper.mTouchSlop * (1 / sensitivity));
        return helper;
    }
     ...
     * @param interpolator interpolator for scroller
     */
    private CustomViewDragHelper(Context context, ViewGroup forParent, Interpolator interpolator, Callback cb) {
        if (forParent == null) {
